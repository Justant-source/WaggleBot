...
- **동적 길이**: "4-second" 하드코딩 제거 → `estimated_tts_sec` 4~6초 클램프 주입. 씬 병합 4.0~6.0초(`scene/settings.yaml`), 프레임 상한 `VIDEO_NUM_FRAMES_MAX=145` → [ADR-0004](../../shared/90-adr/0004-clip-4-6s-frames-145.md).
