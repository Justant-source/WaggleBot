...
echo "     docker compose -f env/docker-compose.yml up fish-speech -d"
echo ""
echo "  2. 모델 로딩 완료 대기 (~90초) 및 로그 확인"
echo "     docker compose -f env/docker-compose.yml logs fish-speech -f"
echo "     # 'Application startup complete.' 메시지 확인"
echo ""
echo "  3. 상태 확인"
echo "     docker compose -f env/docker-compose.yml ps"
...
echo "     docker compose -f env/docker-compose.yml up ai_worker -d"
echo ""
