...
```
/team-agent docs/arch/7.scene_policy_spec.md 제안서 작성해줘
/team-agent docs/arch/7.scene_policy_spec.md 개발 진행해줘
```
...
3. `docs/arch/env/AGENT_TEAM.md`

### 0-2. 스펙 파일 추출

사용자 인자에서 `docs/arch/*.md` 패턴의 파일 경로를 추출하고 해당 파일을 읽는다.
